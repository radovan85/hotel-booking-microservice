...
public class HibernateUtil {
    ...
    private SessionFactory buildSessionFactory() {
        try {
            ...
            configuration.addAnnotatedClass(com.radovan.play.entity.NoteEntity.class);
            configuration.addAnnotatedClass(com.radovan.play.entity.ReservationEntity.class);

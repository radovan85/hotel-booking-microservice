      ...
      <div class="col-lg-8 text-center">
        <section>
          ...
          <p class="text-muted text-center w-75 mx-auto mb-5">
            The hotel is located among trees, overlooking the mountains, where
            nature meets modern style.
          </p>
          ...
          <div class="row g-4">
            <div class="col-md-12 mb-4">
              <div class="card bg-dark text-white">
                <img
                  src="https://mdbootstrap.com/img/Photos/Others/img%20%2832%29.jpg"
                  class="card-img"
                  alt="Hotel"
                />
                <div
                ...
                >
                  <div class="text-center">
                    ...
                    <p class="card-text">
                      Stay with us in
                      <span style="font-family: 'Inria Serif', serif"
                        >Woods</span
                      >. Elegance, luxurious and contemporary design, as well as
                      numerous amenities for guests - these are just some of the
                      advantages of our unique hotel.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div class="card bg-dark text-white">
                ...
                >
                  <div class="text-center">
                    ...
                    <p class="card-text">
                      Not only a hotel, but also a restaurant famous for its
                      delicious cuisine and a large banquet (wedding) room...
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div class="card bg-dark text-white">
                ...
                >
                  <div class="text-center">
                    ...
                    <p class="card-text">
                      We specialize in organizing conferences and special
                      events. Our stylishly furnished rooms, elegant conference
                      rooms...
                    </p>
                  </div>
                </div>
